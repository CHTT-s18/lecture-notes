...
\newcommand{\elofp}[1]{\parens{\elof{#1}}}
...
%
    ...
    &  :
      \piclass{\arrclass{\elof{\nattp}}{\tpsort}}{A}{
      \arrclass{\elof{\parens{\appobj{A}{\zerocon}}}}{
      \arrclass{\parens{
      \piclass{\elof{\nattp}}{m}{
        \arrclass{\elof{\parens{\appobj{A}{m}}}}{\elof{\parens{\appobj{A}{\parens{\succof{m}}}}}}}}}
      {\piclass{\elof{\nattp}}{n}{\elof{\parens{\appobj{A}{n}}}}}}} \\[1ex] 
%
    \reczcon
    & :
      \piclass{\arrclass{\elof{\nattp}}{\tpsort}}{A}{
      \piclass{\elof{\parens{\appobj{A}{\zerocon}}}}{b}{
      \piclass{\piclass{\elof{\nattp}}{m}{\arrclass{\elof{\parens{\appobj{A}{m}}}}{\elof{\parens{\appobj{A}{\parens{\succof{m}}}}}}}}{s}{
      % next line
      }}} \\
    & \qquad
      \eqclass{\elof{\parens{\appobj{A}{\zerocon}}}}{\recof{A}{b}{s}{\zerocon}}{b} \\
%
    \recscon
    & :
      \piclass{\arrclass{\elof{\nattp}}{\tpsort}}{A}{
    ...
    & \qquad
      \piclass{\elof{\nattp}}{n}{
      \eqclass{\elof{\parens{\appobj{A}{n}}}}
...
%
    ...
    & :
      ...
      \arrclass{\parens{\piclass{\elof{A_{1}}}{x}{\elof{\parens{\appobj{A_{2}}{x}}}}}}{
      \elfam{\parens{\piof{A_{1}}{A_{2}}}}}}} \\
    \appcon
    & :
      \piclass{\tpsort}{A_{1}}{
      \piclass{\arrclass{\elof{A_{1}}}{\tpsort}}{A_{2}}{
      \arrclass{\elof{\parens{\piof{A_{1}}{A_{2}}}}}{
      \piclass{\elof{A_{1}}}{x}{\elof{\parens{\appobj{A_{2}}{x}}}}}}} \\[1ex]
%
    \betacon
    & :
      \piclass{\tpsort}{A_{1}}{
      \piclass{\arrclass{\elof{A_{1}}}{\tpsort}}{A_{2}}{
      \piclass{\piclass{\elof{A_{1}}}{x}{\elof{\parens{\appobj{A_{2}}{x}}}}}{F}{
      \piclass{\elof{A_{1}}}{M_{1}}{
      % equation on next line
      }}}} \\
    & \qquad
      \eqclass{\elof{\parens{\appobj{A_{2}}{M_{1}}}}}
    ...
    & :
      \piclass{\tpsort}{A_{1}}{
      \piclass{\arrclass{\elof{A_{1}}}{\tpsort}}{A_{2}}{
      \piclass{\elof{\parens{\piof{A_{1}}{A_{2}}}}}{M}{
      % equation on next line
      }}} \\
    & \qquad
      \eqclass{\elof{\parens{\piof{A_{1}}{A_{2}}}}}
      {M}
      {\lamof{A_{1}}{A_{2}}{\parens{\lamobj{\elof{A_{1}}}{x}{\appof{A_{1}}{A_{2}}{M}{x}}}}}
  \end{align*}
