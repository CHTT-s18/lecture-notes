...
%  \item $\isctx{\extctx{\Gamma_1}{\subst{O_1}{X}{\Gamma_2}}}$.
  \item If\/ $\iscls{\Gamma}{K_{2}}$, then
    $\iscls{\extctx{\Gamma_1}{\subst{O_1}{X}{\Gamma_2}}}{\subst{O_{1}}{X}{K_{2}}}$, and similarly for class equality.
  \item If\/ $\isobj{\Gamma}{O_{2}}{K_{2}}$, then
    $\isobj{\extctx{\Gamma_1}{\subst{O_1}{X}{\Gamma_2}}}{\subst{O_{1}}{X}{O_{2}}}{\subst{O_{1}}{X}{K_{2}}}$,
...
\begin{lemma}[Functionality]
  ...
  \begin{enumerate}
  \item If\/ $\iscls{\Gamma}{K_{2}}$, then
    $\eqcls{\extctx{\Gamma_1}{\subst{O_1}{X}{\Gamma_2}}}{\subst{O_{1}}{X}{K_{2}}}{\subst{O_{1}'}{X}{K_{2}}}$.
  \item If\/ $\isobj{\Gamma}{O_{2}}{K_{2}}$, then
    $\eqobj{\extctx{\Gamma_1}{\subst{O_1}{X}{\Gamma_2}}}{\subst{O_{1}}{X}{O_{2}}}{\subst{O_{1}'}{X}{O_{2}}}{\subst{O_{1}}{X}{K_{2}}}$,
  \end{enumerate}
\end{lemma}
