...
In order to prove Theorem \ref{FTLR}, we need to show: if \hasEF{\Delta}{x}{A}, then \hnorm{\Delta}{A}{x}.
...
We consider the cases for N. It will be easy to satisfy part 1 of lemma \ref{hn-bools}, but we must choose carefully so that we can show part 2: \hnorm{\Delta}{A}{\ifexpr{\hat M}{\hat P}{\hat Q}}.
