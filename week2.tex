...
\scribes{Stephanie Balzer and Yue Niu}
\week{2}
\doXRs
...
\begin{theorem}[Hereditary termination]\label{thm:hterm}
...
\begin{theorem}[Call-by-value hereditary termination]\label{thm:hcbvterm}
  If $\hasEF{\Gamma}{M}{A}$ and $\gamma : \cdot \to \Gamma$ so that
...
\begin{theorem}[Hereditary termination -- semantic formulation]
...
\begin{theorem}[Hereditary normalization]\label{thm:hnorm}
